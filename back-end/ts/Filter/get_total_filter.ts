...
const GetTotalProductsFilter = (req: any, res: any) => {
    ...
    pool.query(query, [categoria, marca, tipo, precio_inicial, precio_final], (err:any, respuesta:any) => {
        if(err) {
            console.log(err);
            return;
        }
