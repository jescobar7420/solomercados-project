...
const GetListSuperProductsId = (req, res) => {
    ...
    let query = `SELECT s.supermercado, sp.id_producto, REPLACE(sp.precio_oferta, 'NA', '-') AS precio_oferta, REPLACE(sp.precio_normal, 'NA', '-') AS precio_normal, sp.url_product, sp.fecha, sp.disponibilidad
